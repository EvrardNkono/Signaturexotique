...
const services = [
  {
    ...
    description: "Livraison gratuite dans un rayon de 20 km en partant du magasin, puis 5€ de frais de 21 à 30 km et 10€ de frais de 31 à 40 km. Au-delà, nous expédions avec soin partout en France. 🚚",
